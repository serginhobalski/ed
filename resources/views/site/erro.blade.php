...
<head>
    ...
    <meta content="Estimular Digital" name="description">
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Trav. Humaitá, 942, Ap 803, Pedreira, Belém-PA</small>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Página não encontrada</h1>
                    <a class="btn btn-primary" href="/" class="h5 text-white"><i class="fa fa-arrow-circle-left"></i> Voltar</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content" style="background: rgba(9, 30, 62, .7);">
                ...
                <div class="modal-body d-flex align-items-center justify-content-center">
                    <div class="input-group" style="max-width: 600px;">
                        <input type="text" class="form-control bg-transparent border-primary p-3" placeholder="Pesquisar">
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0"><?php echo date('Y') ?> &copy; <a class="text-white border-bottom" href="#">Estimular Digital</a>.
						</p>
                    </div>
                </div>
            </div>
